define(['module', '../../scripts/customize/util', '../../scripts/superClass/VmClass', '../../scripts/superClass/mixin', '../../scripts/customize/formatter'], function (module, _util, _VmClass, _mixin, _formatter2) {
    ...
    ViewModel.prototype.init = function () {
        ...
        that.getListAction = _util2.default.getInterface('admin/get_top_menus'); //查询action
        that.addOrEditAction = _util2.default.getInterface('admin/add_or_save_top_menu.mjback'); //增改action
        that.deleteAction = _util2.default.getInterface('admin/del_top_menu.mjback'); //删除action
        that.id = "id"; //主键
